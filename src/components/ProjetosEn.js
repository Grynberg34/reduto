          ...
          <Row>
            ...
            <Col md={4}>
              <div className="projetos__menu">
                <h1 className='projetos__menu__title'>Projects in Development</h1>
            ...
            <Col md={5}>
              ...
              <div className="projetos__projeto">
                ...
                <h2 className="projetos__projeto__info"><span className='projetos__projeto__info__title'>Screenplay:</span> {projetos[projeto].roteiro}</h2>

                <h2 className="projetos__projeto__info"><span className='projetos__projeto__info__title'>Production Company:</span> {projetos[projeto].produtora}</h2>

                {
                  projetos[projeto].laboratórios !== null ?
                  <h2 className="projetos__projeto__info"><span className='projetos__projeto__info__title'>Labs:</span> {projetos[projeto].laboratórios}</h2>
                  :null
                }

                {
                  projetos[projeto].fomento !== null ?
                  <h2 className="projetos__projeto__info"><span className='projetos__projeto__info__title'>Promotion:</span> {projetos[projeto].fomento}</h2>
                  :null
                }     
